...
<div class="breadcrumb-wrapper">
	<ol class="breadcrumb">
		...
		<li class="<?php echo getstate($pageName, 'deploy-3.php'); ?>" ><a href="/deploy/deploy-3.php" ><strong>Step 3:</strong> Confirm </a></li>
		<li class="<?php echo getstate($pageName, 'deploy-4.php'); ?>" ><a href="/deploy/deploy-4.php" ><strong>Step 4:</strong> Deploy </a></li>
	</ol>
</div>